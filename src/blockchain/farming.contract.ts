import { FARMING_CONTRAC_ABI } from '@/abi/farming.contract.abi';
import {
...
export default class FarmingContract {
  public contract;
  public provider;
  ...
  constructor(provider: any) {
    ...
    this.contract = new ethers.Contract(`${import.meta.env.VITE_FARMING_CONTRACT}`, FARMING_CONTRAC_ABI, provider);
  }
    ...
    try {
      ...
      listData = listData.map((item, index) => {
        return {
          ...
          pool: POOL_STAKING_FARMING_DEPOSIT.LP_POOL,
        };
      });
