export const FARMING_CONTRAC_ABI = [
  {
    inputs: [
      { internalType: 'address', name: '_mlc', type: 'address' },
      { internalType: 'contract MetalifePoolFactory', name: '_factory', type: 'address' },
      { internalType: 'address', name: '_poolToken', type: 'address' },
      { internalType: 'uint64', name: '_initBlock', type: 'uint64' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint32', name: '_fromVal', type: 'uint32' },
      { indexed: false, internalType: 'uint32', name: '_toVal', type: 'uint32' },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint64', name: 'lockedFrom', type: 'uint64' },
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: 'address', name: '_by', type: 'address' },
      { indexed: false, internalType: 'uint256', name: 'yieldRewardsPerWeight', type: 'uint256' },
      { indexed: false, internalType: 'uint64', name: 'lastYieldDistribution', type: 'uint64' },
    ],
    name: 'Synchronized',
    type: 'event',
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: 'address', name: '_by', type: 'address' },
      { indexed: false, internalType: 'address', name: '_fromVal', type: 'address' },
      { indexed: false, internalType: 'address', name: '_toVal', type: 'address' },
    ],
  ...
  },
  {
    inputs: [],
    name: 'factory',
    outputs: [{ internalType: 'contract MetalifePoolFactory', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
    inputs: [
      ...
      { internalType: 'bool', name: '_immediate', type: 'bool' },
    ],
    name: 'force_unstake',
    outputs: [],
    stateMutability: 'nonpayable',
    ...
    outputs: [
      {
        ...
        internalType: 'struct MetalifePoolBase.DeactiveStake[]',
        name: '',
        type: 'tuple[]',
      },
    ],
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_rewardsAmount', type: 'uint256' }],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'rewardPerWeight', type: 'uint256' },
    ],
    name: 'rewardToWeight',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
  ...
  {
    inputs: [{ internalType: 'uint32', name: '_weight', type: 'uint32' }],
    name: 'setWeight',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'subYieldRewards', type: 'uint256' },
      { internalType: 'uint256', name: 'subVaultRewards', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_deactiveStakeId', type: 'uint256' }],
    name: 'withdraw',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
